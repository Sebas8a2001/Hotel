...
$(document).ready(function() {
    ...
    function AgregaCompras () {
            ...
            if (code == "") {
                $("#busquedatipo").focus();
                $("#busquedatipo").css('border-color', '#2cabe3');
                swal("Oops", "POR FAVOR REALICE LA BÚSQUEDA DEL PRODUCTO O INSUMO CORRECTAMENTE!", "error");
                return false;
                ...
                $("#descfactura").focus();
                $('#descfactura').css('border-color','#2cabe3');
                ...
                $("#descproducto").focus();
                $('#descproducto').css('border-color','#2cabe3');
                ...
                $("#ivaproducto").focus();
                $('#ivaproducto').css('border-color','#2cabe3');
                swal("Oops", "POR FAVOR SELECCIONE SI TIENE IVA EL PRODUCTO!", "error");
                return false;

            } else if (lote == "") {
                $("#lote").focus();
                $("#lote").css('border-color', '#2cabe3');
                ...
                var nuevaFila =
                    "<tr align='center'>" +
                        ...
                        "<input type='text' id='" + item.cantidad + "' style='width:25px;height:24px;border:#2cabe3;' value='" + item.cantidad + "'>" +
                        '<button class="btn btn-info btn-xs" style="cursor:pointer;" onclick="addItem(' +
                        "'" + item.txtCodigo + "'," +
                        "'+1'," +
                        "'" + item.producto + "'," +
