...
document.title = '.:: Sistema para la Gestión de Reservaciones de Habitaciones ::.';   
$(".current-year").text('2016 - ' + new Date().getFullYear() + ' CopyRight. Todos los Derechos Reservados.');
...
function getTime() 
  {
    ...
    m=checkTime(m);
    s=checkTime(s);
    var fecha = today.getDate() + "-" + num[today.getMonth()] + "-" + today.getFullYear() + " " + h+":"+m+":"+s;
    //var fecha2 = today.getDate() + "-" + num[today.getMonth()] + "-" + today.getFullYear() + " " + h+":"+m+":"+s;
    //$('#result3').html(today.getDate() + "-" + num[today.getMonth()] + "-" + today.getFullYear() + " " + h+":"+m+":"+s);
  
    $("#fecharegistro").val(fecha);
    $("#fecharegistro2").val(fecha);
    $(".fecharegistro").val(fecha);
    $(".fecharegistro2").val(fecha);
