...
if(isset($_POST["proceso"]) and $_POST["proceso"]=="cargaproductos")
{
...
<div id="myModalCargaMasiva" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
            ...
            <form class="form form-material" name="cargaproductos" id="cargaproductos" action="#" enctype="multipart/form-data">
             ...
             <div class="row">
                <div class="col-md-12"> 
                    ...
                    <input type="hidden" name="proceso" id="proceso" value="cargaproductos"/>
        ...
        <div class="modal-footer">
            <button type="button" onClick="CargaDivProductos()" class="btn btn-success"><span class="fa fa-eye"></span> Ver Detalles</button>
            <button type="submit" name="btn-producto" id="btn-producto" class="btn btn-info"><span class="fa fa-cloud-upload"></span> Cargar</button>
