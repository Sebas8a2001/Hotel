    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-header bg-info">
                <h4 class="card-title text-white"><i class="fa fa-file-image-o"></i> Foto de Perfil</h4>
            </div>
...
<?php } else { ?>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group has-feedback">
                            ...
                            <br /><abbr title="Tipo de Documento"><?php echo $_SESSION['documento'] == "" ? "**********" : $_SESSION['documento']; ?></abbr>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group has-feedback">
                            <label class="control-label">Nº de Documento: <span class="symbol required"></span></label>
                            <br /><abbr title="Nº de Documento"><?php echo $_SESSION['dnicliente'] ?></abbr>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group has-feedback">
                            ...
                            <br /><abbr title="Nombre y Apellidos"><?php echo $_SESSION['nomcliente'] ?></abbr>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group has-feedback">
                            <label class="control-label">Nº de Teléfono: <span class="symbol required"></span></label>
                            <br /><abbr title="Nº de Teléfono"><?php echo $_SESSION['telefcliente'] ?></abbr>       
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group has-feedback">
                            ...
                            <br /><abbr title="Pais"><?php echo paises($_SESSION['paiscliente']) ?></abbr>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group has-feedback">
                            ...
                            <br /><abbr title="Ciudad"><?php echo $_SESSION['ciudadcliente'] ?></abbr>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group has-feedback">
                            <label class="control-label">Dirección Domiciliaria: <span class="symbol required"></span></label>
                            <br /><abbr title="Dirección Domiciliaria"><?php echo $_SESSION['direccliente'] ?></abbr>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group has-feedback">
                            ...
                            <br /><abbr title="Correo Electrónico"><?php echo $_SESSION['correocliente'] ?></abbr>
                        </div>
                    </div>
                </div>
<?php } ?>                
