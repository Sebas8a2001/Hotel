...
<body onLoad="muestraReloj()" class="fix-header">
   ...
   <!-- ============================================================== -->
    ...
    <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Créditos por Fechas</h5>
                    </div>
                    <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                <li class="breadcrumb-item">Créditos</li>
                                <li class="breadcrumb-item active" aria-current="page">Por Fechas</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <form class="form form-material" method="post" action="#" name="creditosxfechas" id="creditosxfechas">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group has-feedback">
                    <label class="control-label">Tipo de Crédito: <span class="symbol required"></span></label>
                    <i class="fa fa-bars form-control-feedback"></i>
                    <select style="color:#000;font-weight:bold;" name="url" id="url" class='form-control' required="" aria-required="true">
                        <option value=""> -- SELECCIONE -- </option>
                        <option value="<?php echo encrypt("1"); ?>">RESERVACIONES</option>
                        <option value="<?php echo encrypt("2"); ?>">VENTAS</option>
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group has-feedback">
                    ...
                    <div class="text-right">
                        <button type="button" onClick="BuscarCreditosxFechas()" class="btn btn-info"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestracreditosxfechas"></div>
