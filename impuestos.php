...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-info">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Impuestos</h4>
            </div>
    ...
    <div class="row">
        ...
        <h4 class="card-subtitle m-0 text-dark"><i class="font-20 fa fa-save"></i> Gestión de Impuestos</h4><hr>

        <form class="form form-material" method="post" action="#" name="saveimpuestos" id="saveimpuestos"> 
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control" name="fechaimpuesto" id="fechaimpuesto" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Fecha de Registro" value="<?php echo date("d-m-Y"); ?>" autocomplete="off" readonly="" aria-required="true"/> 
        ...
        <h4 class="card-subtitle m-0 text-dark"><i class="font-20 fa fa-tasks"></i> Búsqueda de Impuestos</h4><hr>
