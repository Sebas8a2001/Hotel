...
<body>
   ...
   <nav class="navbar navbar-expand-md">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link  active dropdown-toggle" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Habitaciones<i class="ti-angle-down"></i></a>
    ...
    <?php
// Recuperar el valor de 'habitacion' desde la URL
    ...
    <section class="rooms-page section-padding" data-scroll-index="1">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="section-title"> <?php echo $habitacion ?> </div>
 
            </div>
                <div class="col-md-8">
                    <p class="mb-30"><?php echo $desHabitacion[0]['descripcion']?></p>
                </div>
