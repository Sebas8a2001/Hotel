...
<!--############################## MODAL PARA VER DETALLES DE CREDITO DE VENTA ######################################-->
...
<div id="myModalPago" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form class="form form-material" method="post" action="#" name="savepagoventas" id="savepagoventas"> 
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group has-feedback">
                    ...
                    <input style="color:#000;font-weight:bold;" type="text" class="form-control" name="nroventa" id="nroventa" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Nº de Venta" autocomplete="off" disabled="" aria-required="true"/> 
                    <i class="fa fa-bolt form-control-feedback"></i>
                </div>
            </div>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    ...
                    <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Créditos en Ventas</h5>
                    </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-info">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Créditos en Ventas</h4>
            </div>
            ...
            <div class="form-body">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <a class="btn waves-effect waves-light btn-light" href="reportepdf?tipo=<?php echo encrypt("CREDITOSXVENTAS") ?>" target="_blank" rel="noopener noreferrer"  data-toggle="tooltip" data-placement="bottom" title="Exportar Pdf"><span class="fa fa-file-pdf-o text-dark"></span> Pdf</a>

                            <a class="btn waves-effect waves-light btn-light" href="reporteexcel?documento=<?php echo encrypt("EXCEL") ?>&tipo=<?php echo encrypt("CREDITOSXVENTAS") ?>" data-toggle="tooltip" data-placement="bottom" title="Exportar Excel"><span class="fa fa-file-excel-o text-dark"></span> Excel</a>

                            <a class="btn waves-effect waves-light btn-light" href="reporteexcel?documento=<?php echo encrypt("WORD") ?>&tipo=<?php echo encrypt("CREDITOSXVENTAS") ?>" data-toggle="tooltip" data-placement="bottom" title="Exportar Word"><span class="fa fa-file-word-o text-dark"></span> Word</a>
                        </div>
                    </div>
                </div>

                <div id="creditosventas"></div>
