...
<!-- /.modal -->
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb border-bottom">
                ...
                <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Reservaciones</h5>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-left" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(164px, 35px, 0px);">
                                ...
                                <a class="dropdown-item" href="reportepdf?tipo=<?php echo encrypt("RESERVACIONES") ?>" target="_blank" rel="noopener noreferrer" data-toggle="tooltip" data-placement="bottom" title="Exportar Pdf"><span class="fa fa-file-pdf-o text-dark"></span> Listado General</a>

                                <a class="dropdown-item" href="reportepdf?tipo=<?php echo encrypt("RESERVACIONESXTARJETAS") ?>" target="_blank" rel="noopener noreferrer" data-toggle="tooltip" data-placement="bottom" title="Exportar Pdf"><span class="fa fa-file-pdf-o text-dark"></span> Listado Tarj. Crédito</a>

                                <a class="dropdown-item" href="reportepdf?tipo=<?php echo encrypt("RESERVACIONESDIARIAS") ?>" target="_blank" rel="noopener noreferrer" data-toggle="tooltip" data-placement="bottom" title="Exportar Pdf"><span class="fa fa-file-pdf-o text-dark"></span> Reservaciones Diarias</a>
