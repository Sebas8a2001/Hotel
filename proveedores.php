...
elseif(isset($_POST["proceso"]) and $_POST["proceso"]=="cargaproveedor")
{
...
<!--############################## MODAL PARA CARGA MASIVA DE PROVEEDOR ######################################-->
<!-- sample modal content -->
<div id="myModalCargaMasiva" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="row">
                <div class="col-md-12"> 
                    ...
                    <input type="hidden" name="proceso" id="proceso" value="cargaproveedor"/>
        ...
        <div class="modal-footer">
            <button type="button" onClick="CargaDivProveedores()" class="btn btn-success"><span class="fa fa-eye"></span> Ver Detalles</button>
            <button type="submit" name="btn-proveedor" id="btn-proveedor" class="btn btn-info"><span class="fa fa-cloud-upload"></span> Cargar</button>
...
<div id="myModalProveedor" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h4 class="modal-title text-white" id="myModalLabel"><i class="fa fa-save"></i> Gestión de Proveedor</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/images/close.png"/></button>
            </div>
            ...
            <div class="form-body">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <button type="button" class="btn btn-success btn-light" data-placement="left" title="Nuevo Proveedor" data-original-title="" data-href="#" data-toggle="modal" data-target="#myModalProveedor" data-backdrop="static" data-keyboard="false"><i class="fa fa-plus"></i> Nuevo</button>
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-left" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(164px, 35px, 0px);">
                                ...
                                <a class="dropdown-item" href="reportepdf?tipo=<?php echo encrypt("PROVEDORES") ?>" target="_blank" rel="noopener noreferrer"  data-toggle="tooltip" data-placement="bottom" title="Exportar Pdf"><span class="fa fa-file-pdf-o text-dark"></span> Pdf</a>

                                <a class="dropdown-item" href="reporteexcel?documento=<?php echo encrypt("EXCEL") ?>&tipo=<?php echo encrypt("PROVEDORES") ?>" data-toggle="tooltip" data-placement="bottom" title="Exportar Excel"><span class="fa fa-file-excel-o text-dark"></span> Excel</a>

                                <a class="dropdown-item" href="reporteexcel?documento=<?php echo encrypt("WORD") ?>&tipo=<?php echo encrypt("PROVEDORES") ?>" data-toggle="tooltip" data-placement="bottom" title="Exportar Word"><span class="fa fa-file-word-o text-dark"></span> Word</a>
