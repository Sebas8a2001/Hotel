    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-info">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Productos por Moneda</h4>
            </div>
             ...
             <div class="form-body">
                ...
                <div class="row">
                    ...
                    <div class="text-right">
                        <button type="button" onClick="BuscaProductosxMoneda()" class="btn btn-info"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
