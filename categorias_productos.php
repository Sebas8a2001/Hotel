...
?>
    ...
    <div id="productList2">
        ...
        $moneda = new Login();
        $cambio = $moneda->MonedaProductoId(); 
        ...
        <div id="<?php echo $producto[$ii]['codproducto']; ?>">
            <div class="darkblue-panel pn" title="<?php echo $producto[$ii]['producto'].' | ('.$producto[$ii]['nomcategoria'].')';?>">
                ...
                <abbr title="<?php echo $cambio == '' ? "" : $cambio[$i]['simbolo'].number_format($producto[$ii]['precioventa']/$cambio[$i]['montocambio'], 2, '.', ','); ?>"><h5 class="text-white pull-right font-12"><?php echo $simbolo.number_format($producto[$ii]['precioventa'], 2, '.', ',');?></h5></abbr> 
                </div>
            </div>
        </div>
