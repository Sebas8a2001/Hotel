...
<body onLoad="muestraReloj()" class="fix-header">
   ...
   <!-- ============================================================== -->
    ...
    <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Reservaciones por Clientes</h5>
                    </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-info">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Reservaciones por Clientes</h4>
            </div>
            
        <form class="form form-material" method="post" action="#" name="reservacionesxclientes" id="reservacionesxclientes">
           ...
           <div class="col-md-12">
                <div class="form-group has-feedback">
                    ...
                    <div class="text-right">
                        <button type="button" onClick="BuscarReservacionesxClientes()" class="btn btn-info"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestrareservacionesxclientes"></div>
